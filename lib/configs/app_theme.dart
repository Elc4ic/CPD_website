...
class AppTheme {
  static final _core = AppCoreTheme(
    shadowSub: const Color(0xff2b5ac0).withAlpha(100),
    primary: const Color(0xff2b5ac0),
    primaryLight: const Color(0xff2b5ac0).withAlpha(100),
  ...
  static AppCoreTheme? core;

  // Init
  static init(BuildContext context) {
    core = isDark(context) ? dark : light;
  }
